...
import com.example.rideshare.config.RateLimitFilter;    
...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilterChain chain(HttpSecurity http, JwtFilter filter, RateLimitFilter rateLimitFilter)
            throws Exception {
